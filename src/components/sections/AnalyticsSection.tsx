...
export function AnalyticsSection() {
  return (
    <Section id="analytics" className="bg-white">
      ...
      <ScrollReveal>
        <div className="ibm-card rounded-sm bg-white p-3 min-[380px]:p-4 sm:p-6 lg:p-8">
          <div className="mb-6 grid gap-3 min-[380px]:grid-cols-2 sm:gap-4 sm:mb-8 lg:grid-cols-4">
            {ANALYTICS_METRICS.map((metric, i) => (
              <motion.div
                ...
                className="rounded-sm border border-gray-200 bg-gray-50 p-3 sm:p-4"
              >
                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-2">
                  {metric.label}
                </div>
                <div className="flex flex-wrap items-end justify-between gap-1.5">
                  <span className="text-xl font-light text-gray-900 sm:text-2xl">{metric.value}</span>
          ...
          <div className="grid lg:grid-cols-3 gap-4">
            <div className="rounded-sm border border-gray-200 bg-white p-3 sm:p-5 lg:col-span-2">
              <div className="text-xs text-gray-500 uppercase tracking-wider mb-4">
                Tarefas executadas — Últimos 30 dias
              </div>
              <div className="flex h-28 items-end gap-0.5 sm:h-36 sm:gap-1">
